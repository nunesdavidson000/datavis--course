  ...
  main.variable(observer("buildvis")).define("buildvis", ["d3","DOM","dataset","forceSimulation","drag"], function(d3,DOM,dataset,forceSimulation,drag)
{
  ...
  // cria constante simulation para receber a funcao forceSimulation e no envento on fazer o tick que esta em outra celula
  ...
  //para criar 
  node.append("title").text((d) => 'artista:'+ d['artist']+ ', nome musica:' +d['name'])
